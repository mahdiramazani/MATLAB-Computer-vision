...
figure;
pic_3=rgb2gray(pic);
subplot(2,2,1),imshow(imfilter(pic_3,mask,3)),title("x");
subplot(2,2,2),imshow(imfilter(pic_3,mask,"symmetric")),title("symmetric");
subplot(2,2,3),imshow(imfilter(pic_3,mask,"replicate")),title("replicate");
subplot(2,2,4),imshow(imfilter(pic_3,mask_2,"circular")),title("circular");

%================== 10000000000000000000000000000000

figure;
pic_2=imread("baby.jpg");
